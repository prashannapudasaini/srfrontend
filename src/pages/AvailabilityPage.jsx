  ...
  const handleSubmit = async () => {
    ...
    try {
      const response = await fetch('/api/user/delivery-schedule', {
        ...
        body: JSON.stringify({ selectedDays, selectedCities }),
      });
          ...
          <div className="flex flex-col lg:flex-row gap-10 items-start">
            ...
            <div className="lg:w-2/3 grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        return (
                          ...
                          >
                            ...
                            <div className={`w-[18px] h-[18px] rounded flex items-center justify-center transition-all duration-200 border ${
                              isCitySelected ? 'bg-[#9e111a] border-[#9e111a]' : 'bg-white border-gray-300'
                            }`}>
              ...
              <div 
                ...
                className="bg-gradient-to-br from-[#002147] to-[#00152e] p-8 rounded-3xl shadow-lg flex flex-col items-center justify-center text-center border border-[#002147] cursor-pointer hover:-translate-y-1 hover:shadow-2xl transition-all duration-300 group"
              >
                ...
                <h3 className="text-xl font-bold text-white mb-2 group-hover:text-[#E2B254] transition-colors">Custom Drop-off?</h3>
                    ...
                    return (
                      <div 
                        ...
                        className={`overflow-hidden rounded-xl border transition-all duration-300 ${
                          isSelected ? 'border-[#9e111a]/30 bg-[#9e111a]/[0.02] shadow-sm' : 'border-gray-100 hover:border-gray-300 bg-white'
                        }`}
                      >
                        <div onClick={() => handleToggleDay(day)} className="flex items-center justify-between p-4 cursor-pointer">
                          <span className={`font-bold text-[15px] ${isSelected ? 'text-[#9e111a]' : 'text-gray-600'}`}>{day}</span>
