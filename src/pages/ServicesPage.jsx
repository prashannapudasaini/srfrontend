          ...
          <div className="max-w-2xl text-left">
            ...
            >
              ...
              <h2 className="text-[#9e111a] text-xs uppercase tracking-[0.3em] font-black">
                Sitaram Gokul Corporate Services
              </h2>
            </motion.div>
            ...
            >
              Modern technology infrastructure channelling urban income directly to rural milk-producing communities.
            </motion.p>
          ...
          {services.map((service) => {
            ...
            return (
              ...
              >
                ...
                <h3 className="text-2xl font-serif font-black text-gray-900 mb-4 transition-colors duration-300 group-hover:text-[#9e111a]">
                  {service.title}
                </h3>
                <p className="text-gray-500 mb-6 font-medium text-sm leading-relaxed">{service.description}</p>
                
                <div className="border-t border-gray-100 pt-6">
                  <ul className="space-y-3">
                    {service.features.map((feature, idx) => (
                      <li key={idx} className="text-sm font-bold flex items-center gap-3 text-gray-600">
